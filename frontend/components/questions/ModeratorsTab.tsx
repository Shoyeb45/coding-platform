...
export const ModeratorsTab: React.FC<ModeratorsTabProps> = ({
  ...
  const fetchModerators = async () => {
    setIsLoading(true);
    try {
      const response = await axios.get(`${process.env.NEXT_PUBLIC_CODING_BACKEND_URL}/problems/moderator/${questionId}`, {
  ...
  const fetchAvailableTeachers = async () => {
    try {
      const response = await axios.get(`${process.env.NEXT_PUBLIC_IOICLUB_BACKEND_URL}/api/teachers/assistant-teachers`, {
        withCredentials: true
      });
  ...
  const addModerators = async () => {
    ...
    setIsSaving(true);
    try {
      const response = await axios.post(`${process.env.NEXT_PUBLIC_CODING_BACKEND_URL}/problems/moderator`, {
  ...
  const removeModerator = async (moderatorId: string) => {
    try {
      const response = await axios.delete(`${process.env.NEXT_PUBLIC_CODING_BACKEND_URL}/problems/moderator/${moderatorId}`, {
        withCredentials: true
      });
