...
export const TestCasesTab: React.FC<TestCasesTabProps> = ({
    ...
    const fetchTestCases = async () => {
        try {
            const response = await axios.get(`${process.env.NEXT_PUBLIC_CODING_BACKEND_URL}/testcases/all/${questionId}`, {
    ...
    const removeTestCase = async (testCaseId: string) => {
        try {
            const response = await axios.delete(
                `${process.env.NEXT_PUBLIC_CODING_BACKEND_URL}/testcases/${testCaseId}`,
                { withCredentials: true }
            );
    ...
    const handleAddTestCaseFromModal = async (testCaseData: {
        ...
        try {
            ...
            const presignResponse = await axios.post(
                `${process.env.NEXT_PUBLIC_CODING_BACKEND_URL}/testcases/${questionId}/presign`,
                {
                    inputFilename,
                    outputFilename
                },
            ...
            const createResponse = await axios.post(
                `${process.env.NEXT_PUBLIC_CODING_BACKEND_URL}/testcases/`,
                {
                    testcases: [{
