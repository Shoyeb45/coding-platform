...
export const CodeStubsTab: React.FC<CodeStubsTabProps> = ({
  ...
  const fetchDriverCodes = async () => {
    try {
      const response = await axios.get(`${process.env.NEXT_PUBLIC_CODING_BACKEND_URL}/problems/driver-code/${questionId}`, {
  ...
  const fetchLanguages = async () => {
    try {
      const response = await axios.get(`${process.env.NEXT_PUBLIC_CODING_BACKEND_URL}/languages`, {
        withCredentials: true,
      });
  ...
  const handleDeleteDriverCode = async (driverCodeId: string) => {
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_CODING_BACKEND_URL}/problems/driver-code/${questionId}?id=${driverCodeId}`, {
        method: 'DELETE',
        credentials: 'include',
