...
export const QuestionDetailsTab: React.FC<QuestionDetailsTabProps> = ({
    ...
    const fetchAvailableTags = async () => {
        try {
            const response = await axios.get(`${process.env.NEXT_PUBLIC_CODING_BACKEND_URL}/tags`, {
    ...
    //             `${process.env.NEXT_PUBLIC_CODING_BACKEND_URL}/problems/${questionId}`,
    //             { ...details },
    //             {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            await axios.patch(
                `${process.env.NEXT_PUBLIC_CODING_BACKEND_URL}/problems/${question.id}`,
                updateData,
                { withCredentials: true }
            );
