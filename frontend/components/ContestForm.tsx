...
const ContestForm: React.FC<ContestFormProps> = ({ contestId: contestIdParam, initialData, mode }) => {
    ...
    const fetchAvailableOptions = async () => {
        try {
            const [languagesRes, tagsRes, batchesRes, moderatorsRes, subjectsRes] = await Promise.all([
                axios.get(`${process.env.NEXT_PUBLIC_CODING_BACKEND_URL}/languages`, { withCredentials: true }),
                axios.get(`${process.env.NEXT_PUBLIC_CODING_BACKEND_URL}/tags`, { withCredentials: true }),
                axios.get(`${process.env.NEXT_PUBLIC_IOICLUB_BACKEND_URL}/api/teachers/batches`, { withCredentials: true }),
                axios.get(`${process.env.NEXT_PUBLIC_IOICLUB_BACKEND_URL}/api/teachers/assistant-teachers`, { withCredentials: true }),
                axios.get(`${process.env.NEXT_PUBLIC_IOICLUB_BACKEND_URL}/api/teachers/subjects`, { withCredentials: true }),
            ]);
    ...
    const fetchContestData = async () => {
        setLoading(true);
        try {
            const response = await axios.get(`${process.env.NEXT_PUBLIC_CODING_BACKEND_URL}/contests/${contestId}`, {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            await axios.patch(`${process.env.NEXT_PUBLIC_CODING_BACKEND_URL}/contests/${contestId}`, updateData, {
                withCredentials: true
            });
