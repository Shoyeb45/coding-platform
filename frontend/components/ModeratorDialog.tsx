...
const ModeratorDialog: React.FC<ModeratorDialogProps> = ({ contestId, isOpen, onClose }) => {
        ...
        const fetchData = async () => {
            try {
                ...
                const teachersRes = await axios.get(
                    `${process.env.NEXT_PUBLIC_IOICLUB_BACKEND_URL}/api/teachers/assistant-teachers`,
                ...
                const moderatorsRes = await axios.get(
                    `${process.env.NEXT_PUBLIC_CODING_BACKEND_URL}/contests/moderators/${contestId}`,
                    { withCredentials: true }
                );
    ...
    const handleRemoveModerator = async (moderatorId: string) => {
        try {
            ...
            await axios.delete(
                `${process.env.NEXT_PUBLIC_CODING_BACKEND_URL}/contests/moderators/${moderatorId}`,
                { withCredentials: true }
            );
