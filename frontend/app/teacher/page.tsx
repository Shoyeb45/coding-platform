...
const ExamDashboard: React.FC = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const [upcomingRes, pastRes] = await Promise.all([
        axios.get(`${process.env.NEXT_PUBLIC_CODING_BACKEND_URL}/contests`, { withCredentials: true }),
        axios.get(`${process.env.NEXT_PUBLIC_CODING_BACKEND_URL}/contests/past`, { withCredentials: true })
      ]);
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      ...
      await axios.delete(`${process.env.NEXT_PUBLIC_CODING_BACKEND_URL}/contests/${examToDelete.id}`, {
