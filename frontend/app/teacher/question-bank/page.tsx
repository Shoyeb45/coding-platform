...
const PracticeQuestions: React.FC = () => {
  ...
  const fetchQuestionsData = async (): Promise<void> => {
    try {
      ...
      const response = await axios.get(`${process.env.NEXT_PUBLIC_CODING_BACKEND_URL}/problems`, {
  ...
  const handleDelete = async (questionId: string) => {
    ...
    try {
      ...
      await axios.delete(`${process.env.NEXT_PUBLIC_CODING_BACKEND_URL}/problems/${questionId}`, {
        withCredentials: true,
      });
