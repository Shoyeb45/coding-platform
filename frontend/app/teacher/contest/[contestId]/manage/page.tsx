...
const ContestManagement: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const fetchContestData = async () => {
            try {
                ...
                const res = await axios.get(`${process.env.NEXT_PUBLIC_CODING_BACKEND_URL}/contests/problem/${contestId}`, {
    ...
    const handleUpdatePoints = async (contestProblemId: string, newPoints: number) => {
        try {
            const res = await axios.patch(
                `${process.env.NEXT_PUBLIC_CODING_BACKEND_URL}/contests/problem/${contestProblemId}`,
                {
                    point: newPoints,
                    contestId
                },
    ...
    const handleRemoveProblem = async (contestProblemId: string) => {
        try {
            await axios.delete(`${process.env.NEXT_PUBLIC_CODING_BACKEND_URL}/contests/problem/${contestProblemId}`, {
                withCredentials: true,
            });
            setContestData((prev) =>
                prev
