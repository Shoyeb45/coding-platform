...
const LeaderboardPage = () => {
  ...
  const fetchLeaderboardData = async () => {
    ...
    try {
      ...
      const res = await axios.get(`${process.env.NEXT_PUBLIC_CODING_BACKEND_URL}/contests/teacher/leaderboard/${contestId}`, {
  ...
  const handlePublish = async () => {
    ...
    try {
      await axios.put(
        `${process.env.NEXT_PUBLIC_CODING_BACKEND_URL}/contests/publish/${contestId}`,
        {},
        { withCredentials: true }
      );
