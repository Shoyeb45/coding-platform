    ...
    const fetchDashboardData = async () => {
        try {
            ...
            const [pastContestsResponse, statsResponse] = await Promise.all([
                axios.get<ApiContestsResponse>(`${process.env.NEXT_PUBLIC_CODING_BACKEND_URL}/students/contest/past`, {
                ...
                axios.get<ApiStatsResponse>(`${process.env.NEXT_PUBLIC_CODING_BACKEND_URL}/students/contest-stats`, {
                    withCredentials: true,
                    timeout: 10000,
                    headers: {
                        'Content-Type': 'application/json',
