  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const [upcomingRes, pastRes] = await Promise.all([
        axios.get(`${process.env.NEXT_PUBLIC_CODING_BACKEND_URL}/students/contest/upcoming`, { withCredentials: true }),
        axios.get(`${process.env.NEXT_PUBLIC_CODING_BACKEND_URL}/students/contest/past`, { withCredentials: true })
      ]);
